    ...
    public partial class AddedModel : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MusicsLabels", x => x.IdMusicLabel);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Albums_MusicsLabels_IdMusicLabel",
                        column: x => x.IdMusicLabel,
                        principalTable: "MusicsLabels",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MusiciansTracks", x => new { x.IdMusician, x.IdTrack });
                    table.ForeignKey(
                        name: "FK_MusiciansTracks_Musicians_IdMusician",
                        column: x => x.IdMusician,
                        principalTable: "Musicians",
                        principalColumn: "IdMusician",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MusiciansTracks_Tracks_IdTrack",
                        column: x => x.IdTrack,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MusiciansTracks_IdTrack",
